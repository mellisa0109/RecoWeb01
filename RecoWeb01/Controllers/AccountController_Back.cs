...
{
    [Authorize]
    public class AccountController_Back : Controller
    {
        private ApplicationSignInManager _signInManager;
        private ApplicationUserManager _userManager;
        private ObjectParameter outMessage;
        IMesEntityRepository repository;
        public AccountController_Back(IMesEntityRepository repositoryParam)
        {
            repository = repositoryParam;
        }

        public AccountController_Back()
        {
        }

        public AccountController_Back(ApplicationUserManager userManager, ApplicationSignInManager signInManager )
        {
